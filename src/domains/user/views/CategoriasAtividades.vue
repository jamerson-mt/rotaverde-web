...
.content > * {
  flex-shrink: 0; /* Garante que os itens não sejam comprimidos */
}
...
.content::-webkit-scrollbar-thumb {
  ...
  border: 3px solid #f0f0f0; /* Espaço entre a barra e o fundo */
}
