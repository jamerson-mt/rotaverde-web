  ...
  if (correct === total) {
    ...
    nextExerciseTimeout = window.setTimeout(() => {
      ...
      if (next < exercises.length) {
        ...
        window.setTimeout(() => {
          loadExercise(0);
          window.location.href = "/att/roadMapPalavra";
        }, 2000);
      }
      nextExerciseTimeout = null;
    }, 1200);
...
<template>
  ...
  <div class="inter-textos">
    ...
    <div id="navButton">
      <button class="floating-button" @click="toggleInfoCard">ℹ️</button>
    </div>

    <div v-if="showInfoCard" class="info-card">
      <h3>Objetivo da Atividade</h3>
      <p>
       Para a interpretação e leitura, a BNCC organiza as habilidades de forma progressiva. Enquanto no 1º ano o foco é decifrar e entender o sentido global, nos anos seguintes o aluno passa a identificar inferências, efeitos de sentido e diferentes gêneros textuais.
      </p>
      <h5>Conexão com a BNCC</h5>
      <ul>
        <li><strong>EF12LP04:</strong> Ler e compreender, em colaboração com os colegas e com a ajuda do professor, fotolegendas de fotos, notícias, manchetes e lides em jornais, revistas e sites infantis.</li>
        <li><strong>EF01LP16:</strong> Ler e compreender, em colaboração com os colegas e com a ajuda do professor, quadras, quadrinhas, parlendas, trava-línguas, cantigas, entre outros textos do campo da vida cotidiana.</li>
         <li><strong>EF02LP12:</strong> Ler e compreender cantigas, quadrinhas, receitas, relatos de experiências, entre outros textos curtos.</li>
